    ...
    if ($password !== $confirm_password) {
        ...
        if ($role === "customer") {
            ...
            if (mysqli_num_rows($check) > 0) {
                ...
                // Insert into users table with membership
            ...
            if (mysqli_num_rows($check) > 0) {
                ...
                // Insert into vendors table with experience
    ...
    <div id="vendorForm" class="register-container" style="display:none;">
        ...
        <form method="POST" action="">
            ...
            <div style="position: relative;">
                ...
                <span onclick="togglePassword('vend_password')" style="position:absolute; right:10px; top:30%; transform:translateY(-50%); cursor:pointer;">👁️</span>
            </div>
            ...
            <div style="position: relative;">
                ...
                <span onclick="togglePassword('vend_confirm_password')" style="position:absolute; right:10px; top:30%; transform:translateY(-50%); cursor:pointer;">👁️</span>
            </div>
